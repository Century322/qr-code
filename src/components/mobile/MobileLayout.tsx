...
export function MobileLayout({ settings, matrix, canvasRef, onDownload, onThemeChange }: MobileLayoutProps) {
  ...
  return (
    <div className={cn(
      ...
      <div className={cn(
        "flex-shrink-0 p-3 px-4 flex items-center justify-between",
        isDarkMode ? "bg-[#2c2c2e] border-b border-[#3a3a3c]" : "bg-white border-b border-[#E5E5EA]"
      )}>
      ...
      >
        <div className={stepContentClass(0, "flex flex-col justify-center p-6 min-h-full")}>
          <div>
        ...
        <div className={stepContentClass(1, "flex flex-col p-6 min-h-full")}>
          <div className="mb-4">
        ...
        <div className={stepContentClass(2, "flex flex-col p-6 min-h-full")}>
        ...
        <div className={stepContentClass(3, "flex flex-col p-6 min-h-full")}>
        ...
        <div className={stepContentClass(4, "flex flex-col p-6 min-h-full overflow-y-auto")}>
          <div className="space-y-5 pt-2">
            <div className={cn(
          ...
          <div className={cn("pt-4 mt-auto border-t", isDarkMode ? "border-[#3a3a3c]" : "border-[#E5E5EA]")}>
      ...
      <div className={cn(
        "flex-shrink-0 p-3 px-4 flex items-center justify-between",
        isDarkMode ? "bg-[#2c2c2e] border-t border-[#3a3a3c]" : "bg-white border-t border-[#E5E5EA]"
      )}>
        <button
